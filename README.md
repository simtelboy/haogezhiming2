...
![image](https://cdn.jsdelivr.net/gh/simtelboy/haogezhiming2/doc/1.png)

请求`/speedtest/`，html5-speedtest测速页面

![image](https://cdn.jsdelivr.net/gh/simtelboy/haogezhiming2/doc/2.png)

请求`/test/`，文件下载速度测试

![image](https://cdn.jsdelivr.net/gh/simtelboy/haogezhiming2/doc/3.png)

请求`/haoge`（可配置）v2ray websocket路径
...
|  WS_PATH | 默认为`/haoge` |  路径，请勿使用`/speedtest`，`/`，`/test` 等已经被占用的请求路径 |
